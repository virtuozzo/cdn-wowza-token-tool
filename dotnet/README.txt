...
BUILD
  ...
  To build, do this at /cdn-wowza-token-tool/dotnet/src
    xbuild
  
  Upon success of the build, you will find the exe(TokenAuthGenerator.exe) file at the folder named 'TokenAuthGenerator/bin/Debug'
